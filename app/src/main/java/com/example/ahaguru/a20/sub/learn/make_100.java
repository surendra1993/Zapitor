...
public class make_100 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lesson_name.setText("Lesson 10 - MAKE 100");
    ...
    private void selectQuestion() {
        ...
        operand2 = 100 - operand1 ;
        qid++;
        response.setVisibility(View.INVISIBLE);
        ansTxt.setVisibility(View.INVISIBLE);
    }
    private int getOperand1() {
        operand1=random.nextInt(100 - 1) + 1;
        return operand1;
    }

    private void gotoNextActivity() {
        Intent intent=new Intent(make_100.this,last.class);
        Bundle b= new Bundle();
        b.putInt("qid",qid);
    ...
    {
        LayoutInflater inflater = LayoutInflater.from(make_100.this);
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(make_100.this);
