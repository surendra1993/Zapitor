...
public class learn4 extends Activity implements View.OnClickListener {

    String enteredAnswer;
    int operand1,operand2,operand3,answer=0,qid=1,enteredAnswer1=0,score=0,mins,secs,wrong=0,op1,op2;
    ...
    private void selectQuestion() {
        ...
        if (op2 < operand2) {
            ...
            operand3 = op1 * 10 + operand2;
            question.setText(operand3 + "-" + op2);
            answer = operand3 - op2;
        }
        qid++;
    }
    ...
    private int getOperand1() {
        operand1 = random.nextInt(18 - 11) + 11;
        return operand1;
    }
    private void gotoNextActivity() {
        Intent intent=new Intent(learn4.this,last.class);
        Bundle b= new Bundle();
        b.putInt("qid",qid);
    ...
    {
        LayoutInflater inflater = LayoutInflater.from(learn4.this);
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(learn4.this);
