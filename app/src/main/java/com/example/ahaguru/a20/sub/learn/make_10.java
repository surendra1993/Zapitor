...
/**
 * Created by Zapitor on 22-12-2016.
 */

public class make_10 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lesson_name.setText("Lesson 10 - MAKE 10");
    ...
    private int getOperand1() {
        operand1=random.nextInt(10 - 0) + 0;
        return operand1;
    }

    private void gotoNextActivity() {

        Intent intent=new Intent(make_10.this,last.class);
        Bundle b= new Bundle();
        b.putInt("qid",qid);
    ...
    {
        LayoutInflater inflater = LayoutInflater.from(make_10.this);
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(make_10.this);
