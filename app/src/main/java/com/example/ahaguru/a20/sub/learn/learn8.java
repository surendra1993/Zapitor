...
public class learn8 extends Activity implements View.OnClickListener {
    String ea1,ea2;
    ...
    private TextView responseTxt,question,lesson_name,hund_ques1,ten_ques1,
            unit_ques1,hund_ques2,ten_ques2,unit_ques2,responseT,h,quest_number;
    ...
    private void gotoNextActivity() {
        Intent intent=new Intent(learn8.this,last.class);
        Bundle b= new Bundle();
        b.putInt("qid",qid);
    ...
    {
        LayoutInflater inflater = LayoutInflater.from(learn8.this);
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(learn8.this);
