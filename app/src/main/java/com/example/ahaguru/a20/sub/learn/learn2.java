...
public class learn2 extends Activity implements View.OnClickListener{
    ...
    private void selectQuestion() {
        ...
        if(operand1 == prev){
            ...
            if (operand1 > operand2) {
                ...
                question.setText(operand2 + "-" + operand1);
    ...
    private void gotoNextActivity() {
        Intent intent=new Intent(learn2.this,last.class);
        Bundle b= new Bundle();
        b.putInt("qid",qid);
    ...
    {
        LayoutInflater inflater = LayoutInflater.from(learn2.this);
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(learn2.this);
